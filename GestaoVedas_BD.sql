...
-- Função que calcula salário anual --
DELIMITER $$

CREATE FUNCTION calculaSalarioAnual(salario DECIMAL(10,2))
...
select nome, calculaSalarioAnual(salario) as SalarioAnual from Vendedor;

-- Procedure que lista todos os funcionários --
DELIMITER $$
...
CREATE PROCEDURE insereProduto(
	IN nomeItem VARCHAR(100), 
    IN precoUnit DECIMAL(10,2), 
    IN estoqueQtd INT)
BEGIN 
	INSERT INTO Produto(nome, preco, estoque)
	VALUES (nomeItem, precoUnit, estoqueQtd);
END $$
DELIMITER ;

call insereProduto ('KIT de discos', 120.00, 20);

-- criar views de lista de funcionário e salário -- 
